...
import { Building, Eye, EyeOff, Loader2, LogIn, ShieldCheck, TriangleAlert } from 'lucide-react';
...
export default function LoginPage() {
  ...
  /** Set when one address belongs to more than one office. */
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">سجّل الدخول للوصول إلى مكتبك</p>
          </div>
        </div>
        ...
        <p className="text-center text-[11px] text-slate-500 mt-5">
          لا تملك حساباً؟ الانضمام يتم بدعوة من مالك المكتب فقط.
        </p>
      </div>
    </div>
  );
