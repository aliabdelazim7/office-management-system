...
export default function Sidebar({
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-[#101418] text-[#f3f4f6] border-l border-[#222733]">
      <div className="p-4 sm:p-5 border-b border-[#222733] flex items-center justify-between gap-3">
        ...
        {onCloseMobile && (
          <button
            ...
            className="lg:hidden p-1.5 rounded-lg text-slate-400 hover:text-white bg-slate-800 transition-colors"
      ...
      <div className="mx-4 my-3 p-2 rounded-lg bg-[#14181f] border border-[#222733] flex items-center justify-between text-xs">
        <span className="text-slate-400 font-medium text-[11px]">الدور الحالي:</span>
        <span className="px-2 py-0.5 rounded font-bold bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-[11px]">
      ...
      <div className="p-4 border-t border-[#222733] bg-[#0b0f14]/60">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-[#1a202c] border border-[#222733] flex items-center justify-center font-bold text-indigo-400 text-xs shrink-0">
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex w-72 bg-[#101418] border-l border-[#222733] flex-col h-screen sticky top-0 z-40 shrink-0">
        {sidebarContent}
      </aside>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden">
          <div
            ...
            onClick={onCloseMobile}
          />
          <aside className="relative w-80 max-w-[85vw] bg-[#101418] h-full border-l border-[#222733] shadow-subtle-lg flex flex-col z-50 mr-auto">
            {sidebarContent}
          </aside>
        </div>
      )}
